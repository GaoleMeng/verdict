...
public class VerdictResultSetMetaDataOrg implements ResultSetMetaData {
    ...
    public VerdictResultSetMetaDataOrg(ResultSetMetaData meta, VerdictApproxResultMeta columnInfo) {
        this.meta = meta;
