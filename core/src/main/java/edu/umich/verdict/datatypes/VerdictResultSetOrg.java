...
public class VerdictResultSetOrg implements ResultSet {
     ...
     */
    public VerdictResultSetOrg(ResultSet resultSet, VerdictApproxResultMeta columnInfo) {
        this.resultSet = resultSet;
        this.columnInfo = columnInfo;
    }

    public VerdictResultSetOrg(ResultSet resultSet, VerdictApproxResultMeta columnInfo, Map<Integer, Integer> columnMap) {
        this(resultSet, columnInfo);
        this.columnMap = columnMap;
    }

    public static VerdictResultSetOrg emptyResult() {
        final VerdictResultSetMetaDataOrg meta = new VerdictResultSetMetaDataOrg(null, null) {
            @Override
        ...
        VerdictResultSetOrg rs = new VerdictResultSetOrg(null, null) {
            @Override
            public boolean next() {
                return false;
            }
    ...
    public static VerdictResultSetOrg fromList(final List<List<String>> data, final List<String> columnLabels) {
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        if (columnMap == null)
            return new VerdictResultSetMetaDataOrg(resultSet.getMetaData(), columnInfo);
        else
            return new VerdictResultSetMetaDataOrg(resultSet.getMetaData(), columnInfo, columnMap);
    }
